...
- Mitigation policy seeds are declared in source with `LH_POLICY_SEED(domain, name, "literal")`.
...
- Coherence is owned by mitigation code and shared mitigation helpers, not by central coherence/cohort profiles.

...
/** Derives mitigation-owned bytes from a practical seed, policy seed, scope, and optional context. */
LH_INTERNAL bool LHMitigationDeriveBytes(const LHSeed *seed,
...
LH_INTERNAL bool LHMitigationDeriveU64(const LHSeed *seed,
                                       const LHPolicySeed *policySeed,
                                       const LHScope *scope,
                                       const uint8_t *context,
                                       size_t contextLength,
...
LH_INTERNAL bool LHMitigationDeriveBoundedU64(const LHSeed *seed,
                                              const LHPolicySeed *policySeed,
                                              const LHScope *scope,
                                              const uint8_t *context,
                                              size_t contextLength,
...
LH_INTERNAL bool LHMitigationDeriveUUIDString(const LHSeed *seed,
                                              const LHPolicySeed *policySeed,
                                              const LHScope *scope,
                                              char *output,
                                              size_t outputLength);
/** Derives an ASCII string of `length` characters from `alphabet`. */
LH_INTERNAL bool LHMitigationDeriveASCIIString(const LHSeed *seed,
                                               const LHPolicySeed *policySeed,
                                               const LHScope *scope,
                                               const char *alphabet,
                                               size_t length,
...
LH_INTERNAL bool LHMitigationDeriveTimeIntervalBetween(const LHSeed *seed,
                                                       const LHPolicySeed *policySeed,
                                                       const LHScope *scope,

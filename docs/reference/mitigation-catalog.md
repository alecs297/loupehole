...
The catalog does not own mitigation value definitions. A mitigation declares its own policy seeds in source with `LH_POLICY_SEED(domain, name, "literal")`, and its mitigation page documents those seeds.
